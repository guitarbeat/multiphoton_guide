...
class BaseMeasurementModule(ABC):
    ...
    def render_tips(self) -> None:
        ...
        create_info_box("Override render_tips() method to provide module-specific tips.")
    ...
    def log_measurement(self, activity: str, description: str, category: str = "Measurement") -> None:
...
def create_standard_theory_procedure_tabs(theory_content: str, procedure_content: str,
...
def create_standard_measurement_form(df_type: str, 
                                   form_fields: Dict[str, Dict],
                                   form_key: str = "measurement_form",
                                   validation_config: Dict[str, Dict] = None) -> bool:
...
def create_standard_visualization_section(df_type: str, 
    ...
    if metrics_function:
        safe_execute(
            lambda: metrics_function(df),
            error_message="Failed to calculate metrics"
        )
    
    # Create and display plot
    safe_execute(
        lambda: plot_function(df),
...
def create_module_status_indicator(module_name: str, 
                                 has_data: bool, 
                                 data_count: int = 0,
